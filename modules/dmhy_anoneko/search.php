...
class TorrentSearchDmhyAnoneko
{
    private $pagePrefix = 'https://dmhy.anoneko.com';
    private $qurl = 'https://dmhy.anoneko.com/topics/rss/rss.xml?keyword=';
...
if (!debug_backtrace()) {
    ...
    $module = 'TorrentSearchDmhyAnoneko';
    $query = 'gintama';
